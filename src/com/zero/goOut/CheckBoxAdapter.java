...
public class CheckBoxAdapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		if (holder == null) {
			...
			if (view == null) {
				view = inflater.inflate(R.layout.bus_track_checkbox_list_item, null);
			}

			holder.tv = (TextView) view.findViewById(R.id.checkbox_list_textView_item);
			holder.cb = (CheckBox) view.findViewById(R.id.checkbox_list_checkbox_item);
			view.setTag(holder);
		} else {

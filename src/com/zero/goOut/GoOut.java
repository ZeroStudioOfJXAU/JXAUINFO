...
public class GoOut {
	...
	private boolean getBus(String lineName, String location, int dire, List<BusInfo> list) {
		...
		if (dire == 1)
			...
			realDire = 1;
		String url3 = "http://mybus.jx139.com/LineDetailQuery?lineId=" + lineName
				+ "&direction=" + realDire + "&";
		try{
			...
			if (info3 != "") {
				...
				if (mainInfo != "") {
					List<SubBusInfo> subBusInfo = HtmlDeal.SolveCase(mainInfo, location);
